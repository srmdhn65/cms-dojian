...
const TabsAccordions = () => {
  ...
  const accordianContent2: TabContentType[] = [
    ...
    {
      id: 4,
      title: "Will you regularly give updates of Dojian ?",
      text: "Yes, We will update the Dojian regularly. All the future updates would be available without any cost",
    },
  ];
