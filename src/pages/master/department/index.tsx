...
const DepartmentList = () => {
    ...
    const [items, setItems] = useState<DepartmentInterface[]>([]);
        ...
        <>
            <PageTitle
                breadCrumbItems={[
                    ...
                    { label: "Departments", path: "/master/departments", active: true },
                ]}
                        ...
                        <Card.Body>
                            <Row>
                                <Col sm={4}>
                                    <CustomButton
                                        type="button"
                                        onClick={() => navigate("/master/departments/create")}
                                        label="Tambah Data"
                                    />
                                </Col>
                                {/* <Col sm={8}>
                            ...
                            <table className="table table-striped">
                                ...
                                <tbody>
                                    {items.map((item: DepartmentInterface, key: number) => (
                                        <tr key={item.id}>
